            ...
            <ScrollView>
                <View  style={styles.ordersMainContainerView}>
                    ...
                    <View style={styles.feedbacktitleView}>
                        <Text  style={styles.feedbackLables}>About Dr Kg Beddings </Text>
                    </View>
                        <Text  style={styles.orderListLables}>For Inquiries Or Customer Care</Text>
                        <Text  onPress={()=>{Linking.openURL('tel:0701106459');}} style={styles.orderListLables}> Call :: 0701 106 459 </Text>
                        <Text  onPress={()=>{Linking.openURL('tel:0704188834');}} style={styles.orderListLables}> Call :: 0704 188 834 </Text>
                        <Text  onPress={()=>{Linking.openURL('tel:0788666309');}} style={styles.orderListLables}> Call :: 0788 666 309 </Text>
                        <Text  onPress={()=>{Linking.openURL('mailto:drkgbeddingsofficial@gmail.com.com');}} style={styles.orderListLables}>Or Email ::</Text>
                        <Text  onPress={()=>{Linking.openURL('mailto:drkgbeddingsofficial@gmail.com.com');}} style={styles.orderListLables}> drkgbeddingsofficial@gmail.com</Text>
                ...
                <View  style={styles.ordersMainContainerView}>
                    <View style={styles.feedbackLableView}>
                    <View style={styles.feedbacktitleView}>
                        <Text  style={styles.feedbackLables}>About Developer </Text>
                    </View>
                        ...
                        <Text  onPress={()=>{Linking.openURL('tel:0701243139');}} style={styles.orderListLables}>Or Call :: 0701 243 139  </Text>
