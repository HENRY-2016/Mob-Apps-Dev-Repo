            ...
            <View style={{marginTop:20}}>
                <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} onScroll={this.change} style={{width,height}}>
                    {this.props.images && this.props.images.map((image,index) =>(
                        ...
                        <Image key={index} source={{uri: image}} style={{width,height, borderColor:COLORS.orangeColor,borderWidth: 5,resizeMode:'cover'}} />
...
Title:{color:COLORS.MainColorOne,fontSize:25,},
SubTitle:{color:COLORS.MainColorOne,fontSize:20,},
SliderImageDotText:{color:COLORS.MainColorOne,fontSize:25,},
SliderImageActiveDotText:{color:COLORS.orangeColor,fontSize:25,},
SliderImageCaptionView:{marginTop:30,alignSelf:"center",},
}
)