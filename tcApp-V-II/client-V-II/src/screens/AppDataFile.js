...
import { APIListAllHolidayHomes,APIGetAgencyJobs,APIListHealthHospitals, 
        APIProvidersListAll,
        } from "./DataFileApis";

export const HealthInsuranceData=[];export const HealthHospitalsData=[];
export const AgencyJobsData=[];export const HolidayHomesData=[];
export const ProvidersListData=[];


export const LoadAgencyData = () =>{getAppData(APIGetAgencyJobs,AgencyJobsData)}
export const LoadHealthAppData = () =>{getAppData(APIListHealthHospitals,HealthHospitalsData)}
export const LoadHolidayHomesAppData = () =>{getAppData(APIListAllHolidayHomes,HolidayHomesData)}
export const LoadProvidersListAppData = () =>{getAppData(APIProvidersListAll,ProvidersListData)}
