...
// var BaseUrl = "http://192.168.20.195:8000"; // Ethernet
...
export const APIPostAgencyApplication = BaseUrl+"/api/agency/user/application/post";
...
// other services 
export const APIPostServicesBooking = BaseUrl+"/api/services/user/booking/post";


export const APIViewPdfFile = BaseUrl+PdfUrl;
