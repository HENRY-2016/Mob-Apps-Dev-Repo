...
// APIs
import {URLViewBedRoomThreeClosets,URLViewBedRoomThreeShoeRack,URLViewBedRoomThreeMirrors,URLViewBedRoomThreeNightWear,URLViewBedRoomThreeSandals} from './DataFileApis';

const {width} = Dimensions.get("window");
const height = width * 7; 

export default class ViewBedRoomThree extends React.Component {
        ...
        <View style={styles.mainView}>
            <View style={styles.topNavigationHeader}>
                ...
                <View style = { styles.productTopTitleNameView}>
                    <Text style = { styles.productTopTitleName}> BedRoom 3 :: View :: Items </Text>
                </View> 
            </View>
            ...
            <View style={{height:25}} ></View>
                <ScrollView>
                    ...
                    {DoNotShowItemsListingScreen?(<></>):(<>
                        <View style={styles.ordersDetailsBtnView}>
                            <TouchableOpacity onPress={()=>{this.showItemsWebViewScreen(URLViewBedRoomThreeClosets)}} style={styles.productNameListingBtn} >
                                <Text style={styles.orderdetailsBtnText} >: View : Closets Items </Text> 
                            </TouchableOpacity>
                        </View>
                        <View style={{height:25}}></View>
                        <View style={styles.ordersDetailsBtnView}>
                            <TouchableOpacity onPress={()=>{this.showItemsWebViewScreen(URLViewBedRoomThreeShoeRack)}} style={styles.productNameListingBtn} >
                                <Text style={styles.orderdetailsBtnText} >: View : Shoe Racks Items</Text> 
                            </TouchableOpacity>
                        </View>
                        <View style={{height:25}}></View>
                        <View style={styles.ordersDetailsBtnView}>
                            <TouchableOpacity onPress={()=>{this.showItemsWebViewScreen(URLViewBedRoomThreeMirrors)}} style={styles.productNameListingBtn} >
                                <Text style={styles.orderdetailsBtnText} >: View : Mirrors Items</Text> 
                            </TouchableOpacity>
                        </View>
                        <View style={{height:25}}></View>
                        <View style={styles.ordersDetailsBtnView}>
                            <TouchableOpacity onPress={()=>{this.showItemsWebViewScreen(URLViewBedRoomThreeNightWear)}} style={styles.productNameListingBtn} >
                                <Text style={styles.orderdetailsBtnText} >: View : Night Wear Items</Text> 
                            </TouchableOpacity>
                        </View>
                        <View style={{height:25}}></View>
                        <View style={styles.ordersDetailsBtnView}>
                            <TouchableOpacity onPress={()=>{this.showItemsWebViewScreen(URLViewBedRoomThreeSandals)}} style={styles.productNameListingBtn} >
                                <Text style={styles.orderdetailsBtnText} >: View : Sandals Items</Text> 
                            </TouchableOpacity>
                        </View>
                    </>)}
