...
// APIs
import {APIListClearedOrders,APIListCustomerOrderListArray,imageUrl} from './2DataFileApis';
...
render() {
    ...
    const { ClearedOrderDetails,OrderListArrary} = this.state;
        ...
        <View style={styles.mainView}>
            ...
            <View style={styles.topNavigationHeader}>
                ...
                <View style = { styles.productTopTitleNameView}>
                    <Text style = { styles.productTopTitleName}> Old Ver : Orders :: Cleared </Text>
                </View> 
