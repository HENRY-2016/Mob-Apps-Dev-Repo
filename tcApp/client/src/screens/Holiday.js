...
import {APIListAllHolidayHomes, ImageUrl,APIPostHomesOrders,APIPostHomesFeedBacks} from './DataFileApis';
import { COLORS } from './Colours';
import {Picker} from '@react-native-picker/picker';

import { HolidayHomes} from './AppDataFile';
import YoutubePlayer from 'react-native-youtube-iframe';
import TcHomesImg from "../imgs/homes.png";
...
postHolidayHomesFeedBack = async () => 
{
    ...
    else
    {
        try
        {
            ...
            let result = postRequest.data.status;
            Alert.alert("FeedBack Status",name+"\n"+result);
        }

        catch (error)
            {console.log(error); Alert.alert("An Error","Host Not Found Or Check\n\nYour Network Connections\n\n")};
    }
}
render() {
    ...
    const {DoNotShowAmenitiesScreen,DoNotShowAboutScreen,DoNotShowHomesScreen,
        ...
        <View style={styles.mainView}>
            <View style={styles.topNavigationHeader}>
                ...
                <View style={styles.MainTopHeaderView} >
                    <View style={styles.MainTopHeaderTextView1}>
                        <Text style={styles.MainTopHeaderTextLabel}> Welcome To Tc {"\n"}Holiday Homes </Text>
                    </View>
                </View>
            ...
            <View style={styles.MainNavigationBtnView}>
                ...
                <View style={styles.MainNavigationBtnSpaceView} ></View>
                    ...
                    <View style={styles.MainNavigationBtnSpaceView} ></View>
                    <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn1]} onPress={this.showVisitorsFeedBackScreen}  >
                        ...
                        <View style={styles.ImageVideoView}>
                            ...
                            <View style={styles.HolidayHomeActionView}>
                                ...
                                <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} >
                                        ...
                                        <View style={styles.MainNavigationBtnSpaceView} ></View>
                                        <TouchableOpacity style={[styles.ActionBtn, styles.MainNavigationBtn1]}  onPress={()=> this.showBookingScreen(item.Country,item.Area)}  >
                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View style={styles.MainOuterCardListView} >
                        ...
                        <View style={{alignItems:'center'}} >
                            <Image source={TcHomesImg} style={styles.TcHomesIcon}/>
                            <View style={{height:20}} ></View>
                        </View>
                ...
                {DonNotShowVisitorsFeedBackScreen ?(<></>):(<>
                    <ScrollView showsVerticalScrollIndicator={false} >
                        <View style={{alignItems:'center'}} >
                            <Image source={TcHomesImg} style={styles.TcHomesIcon}/>
                            <View style={{height:20}} ></View>
                            <Text style={styles.AboutTitleText} >VISITOR'S FEEDBACK</Text>
                        </View>

                        <View style={{height:20}} ></View>
                        <Text style={styles.AboutTitleText} >Dear Visitor,{"\n\n"}
                        ...
                        <View style={{height:20}} ></View>
                        <Text style={styles.AboutTitleText} >PLEASE TICK JUST ONE BOX PER QUESTION OR THE N/A BOX IF NOT APPLICABLE{"\n\n"}Please Tick only 1 appropriate Box</Text>
                        <View style={{height:20}} ></View>

                        <Text style={styles.AboutText} >1. Does the Home smell Pleasant?</Text>
                        ...
                        <Text style={styles.AboutText} >2. Is the Home clean and tidy when you visit?</Text>
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >3. Is the House clean and tidy when you visit?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                        ...
                        <Text style={styles.AboutText} >4. Do you receive a warm welcome when you visit?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                        ...
                        <Text style={styles.AboutText} >5. Are the staff generally friendly and helpful?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                        ...
                        <Text style={styles.AboutText} >6. Is the general level of decoration in good order?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >7. Do you feel the Home provides a safe enviroment?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                        ...
                        <Text style={styles.AboutText} >8. Is the level of noise acceptable when you visit?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >9. Are refreshments available to you when you visit?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                        ...
                        <Text style={styles.AboutText} >10. Is the furniture clean, comfortable & in good repair?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >11. Is the outside of the Home clean & tidy when you visit?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >12. Do the staff conduct themselves in a professional manner?</Text>
                            <View style={styles.checkboxContainer}>
                                <Pressable
                            ...
                            <View style={{height:10}}></View>
                        <Text style={styles.AboutText} >13. Are you happy with the quality and available of the meals and drinks that you receive?</Text>
                        <View style={styles.checkboxContainer}>
                            <Pressable
                        ...
                        <View style={{height:10}}></View>
                        <TextInput style={styles.input} placeholder="Your Name" onChangeText={text => this.setFeedBackUserName(text)}  
                            placeholderTextColor = "#5800c4"/>
                        <TextInput style={styles.input} placeholder="Mobile Number" onChangeText={text => this.setFeedBackUserPhone(text)}
                            placeholderTextColor = "#5800c4"/>
                        ...
                        <View style={{height:30}} ></View>
                        <View style={{alignItems: "center"}}>
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn1]} onPress={this.postHolidayHomesFeedBack}>
                        ...
                        <View style={{height:20}} ></View>
                        <Text style={styles.AboutText} >-------- Thank you for visiting TC Holiday Homes --------</Text>
                        <View style={{height:20}} ></View>
                    </ScrollView>
                </>)}
