...
export default class Saloon extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            ...
            <View style={styles.mainView}>
                <View style={styles.topNavigationHeader}>
                    ...
                    {/* <View style = { styles.productTopTitleNameView}>
                        <Text style = { styles.productTopTitleName}> Saloon </Text>
                    </View> */}
                ...
                <ScrollView>
                    <View style={styles.MainTopHeaderView} >
                        <View style={styles.MainTopHeaderTextView}>
                            <Text style={styles.MainTopHeaderTextLabel}> Saloon </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.MainNavigationBtnView}>
                        ...
                        <View style={styles.MainNavigationBtnSpaceView} ></View>
                            ...
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn1]} onPress={this.showHomeScreen} >
                                <Text style = {styles.btnText}> Ladies  </Text>
                            </TouchableOpacity>

                            <View style={styles.MainNavigationBtnSpaceView} ></View>
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn1]} onPress={this.showAboutScreen} >
                                <Text style = {styles.btnText}> Gents </Text>
                            </TouchableOpacity>

                            {/* <View style={styles.MainNavigationBtnSpaceView} ></View>
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn2]} onPress={this.showEmployeeScreen} >
                                <Text style = {styles.btnText}> Employee </Text>
                            </TouchableOpacity>

                            <View style={styles.MainNavigationBtnSpaceView} ></View>
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn2]} onPress={this.showEmployerScreen}  >
