...
import {
        ...
        APIClubMemberAllRenewals,APIPostImg,
    } from './DataFileApis';
...
constructor(props){
    ...
    this.state = {
        ...
        DoNotShowUserAccountScreen:false,
...
render() {
    ...
    const {ClubMemberName,ClubClaims,ClubMemberCategory,ClubMemberPoints,ClubMemberSavings,IsMemberLogeIn} = this.state;
                    ...
                    {DoNotShowUserAccountScreen ?<></>:(<>
                        <View style = {[styles.UserProfileView]} >
                            ...
                            <View style = {[styles.UserProfileNameView]} >
                                ...
                                <View style={{height:20}} ></View>
                                <Text style = {styles.btnText}> {ClubMemberCategory}  </Text>

                                <View style={{height:20}} ></View>
                                <Text style = {styles.btnText}> {ClubMemberPayment}  </Text>
                        ...
                        <View key={index} >
                            ...
                            <View style = {[styles.DashBoardMainCardsView,styles.DashBoardMainCardsView1]} >
                                
                                        <View style = {[styles.DashBoardCardsView]} >
                                            <View style={styles.CardTextLabelInnerView1} >
                                                <Text style = { styles.btnText}> Fee  </Text>
                                                <View style={{height:20}} ></View>
                                                <Text style = { styles.btnText}> {item.Fee} </Text>
                                                <View style={{height:30}} ></View>
                                                <Text style = { styles.btnText}> Renewal </Text>
                                                <View style={{height:20}} ></View>
                                                <Text style = { styles.btnText}> {item.Renewal} </Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style = {[styles.DashBoardCardsView]} >
                                            <View style={styles.CardTextLabelInnerView1} >
                                                ...
                                                <View style={{height:20}} ></View>
                                                <Text style = { styles.btnText}> {item.DateOne} </Text>
                                                <View style={{height:20}} ></View>
                                                <Text style = { styles.btnText}> To </Text>
                                                <View style={{height:20}} ></View>
                                                <Text style = { styles.btnText}> {item.DateTwo} </Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                        ...
                        <View style = {[styles.DashBoardView]} >
                            <View style = {[styles.DashBoardMainCardsView,styles.DashBoardMainCardsView2]} >
