...
logInUser = async () =>
{
    ...
    render() {
        ...
        const {DoNotShowProvidersScreen,DoNotShowLogInScreen,DoNotShowProviderLogInScreen,} = this.state;
                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View style={styles.MainNavigationBtnView}>
                        ...
                        <View style={styles.MainNavigationBtnSpaceView} ></View>
                            ...
                            <View style={styles.MainNavigationBtnSpaceView} ></View>
                            <TouchableOpacity style={[styles.MainNavigationBtn, styles.MainNavigationBtn1]} onPress={this.showProvidersScreen} >
                                <Text style = {styles.btnText}> Providers </Text>
                            </TouchableOpacity>
